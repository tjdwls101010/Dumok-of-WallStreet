# SidneyKim0 Cross-Asset Analysis Framework

## Overview

Cross-asset relationships form the empirical backbone of macro regime identification. No single asset tells the complete story — the pattern of relationships between assets reveals the underlying regime and flags transitions before they are visible in any single price series.

> "달러, 금리, 증시의 3각 관계를 먼저 파악하고, 그 다음 개별 자산을 본다"

---

## The Core Triangle: Rates — Dollar — Risk Assets

The most fundamental cross-asset relationship is the interaction among US interest rates, the US dollar, and risk assets (equities, credit, EM).

### Normal Relationships
| Condition | Expected Behavior |
|-----------|------------------|
| Rates rise (growth-driven) | USD neutral/weak; equities stable/up |
| Rates rise (inflation-driven) | USD strong; equities down |
| Rates fall (Fed cutting) | USD weak; equities up; EM rally |
| USD strengthens | EM equities down; commodities pressured |
| USD weakens | EM equities rally; commodities up |

### Anomaly Signals (Regime Transition Indicators)
When the normal relationships break down, a regime transition is likely underway:
...
### Curve Shapes and Market Implications

**Bear Steepening** (long rates rise faster than short rates):
- Drivers: Inflation expectations, term premium expansion, fiscal risk
...
- Equity impact: Initially negative (recession fear), then positive as easing takes hold
- EM impact: Positive medium-term if driven by Fed pivot

**Bear Flattening** (short rates rise faster than long rates):
- Drivers: Early Fed tightening cycle
- Equity impact: Mixed — value outperforms growth
- Historical: 2022 early phase

**Inversion** (short > long):
- Historical recession precursor with 12-18 month lead time
- Most reliable signal for late-cycle positioning

**Partial Inversion Anomaly** (US10Y-2Y positive, US10Y-3M negative):
- Occurred in September-October 1998 and March 2025
...
### Role in the Macro Framework

DXY is the global liquidity transmission mechanism. Dollar strength is not just a US story — it determines global credit conditions, EM debt serviceability, and commodity price dynamics.

### DXY Trend Interpretation
| DXY Trend | Global Implication |
|-----------|-------------------|
...
### Gold's Dual Role
Gold is simultaneously a safe-haven asset and an inflation hedge. Its behavior relative to the dollar reveals which role dominates.

**Gold as Safe Haven** (risk-off regime):
...
1. Global everything rally: Gold, EM equities, commodities all rally together
2. Gold peaks first and holds (transitions to safe-haven)
3. Non-gold commodities collapse (BDI, metals)
...
## Liquidity Framework: TGA, RRP, Fed Balance Sheet

### Net Liquidity Formula
```
Fed Net Liquidity = Fed Balance Sheet − Treasury General Account (TGA) − Reverse Repo (RRP)
```
...
|---------------------|------------------|
| Rising (QE + TGA drain + RRP decline) | Liquidity expanding; risk assets positive |
...
### High-Yield Spread as Risk Barometer
...
## Commodity-Macro Connection

### Baltic Dry Index (BDI)
BDI tracks real shipping rates for bulk dry goods — a real-time proxy for global trade volume.
...
## Cross-Asset Divergence / Convergence Detection

### Divergence Framework
A divergence occurs when assets that should move together (based on historical correlation) begin moving in opposite directions.

**High-Alpha Divergences**:
1. **Risk assets rally while credit spreads widen**: Equity running ahead of credit
...
"이격 해소" (gap resolution) = the convergence process. Track:
- The size of the divergence in standard deviation terms
...
### Macro-Driven Sector Rotation Map

| Macro Regime | Outperforming Sectors | Underperforming Sectors |
|--------------|----------------------|------------------------|
| 실적장세 | Tech, Consumer Discretionary, Industrials | Utilities, Staples |
| 역금융장세 | Energy, Materials, Financials | Tech, Growth, Duration |
| 역실적장세 | Utilities, Staples, Healthcare | Everything cyclical |
| 유동성 쏠림 | US large-cap quality | EM equities, HY bonds, Speculative commodities |
