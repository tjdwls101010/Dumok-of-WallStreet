...
[![Version](https://img.shields.io/badge/version-6.5.1-green?style=flat-square)](CHANGELOG.db)
...
| 서브커맨드 | 설명 |
|-----------|------|
| `analyze` | 단일 종목 SEPA 종합 진단 (18개 모듈 병렬 실행) |
| `discover` | 시장 환경 + RS 리더 발굴 + Distribution Day 카운팅 |
| `compare` | 복수 종목 SEPA 점수 비교 |
| `recheck` | 보유 종목 포지션 관리 (Tennis Ball/Egg 판별) |
