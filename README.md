...
|--------|---------|----------|-------------|
| **Invest** | 2.8.1 | Finance | Financial market data analysis with MarketData skill and analyst personas |
| **Study** | 1.1.3 | Education | Study and knowledge management with PDF, presentation, NotebookLM |
